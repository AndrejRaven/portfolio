            ...
            >
              <Grid item sm={6}>
                <div className={classes.mainFeaturesPostContent}>
                  ...
                  <Button variant="contained" color="secondary" className={classes.margin} href='https://drive.google.com/file/d/12N6U9i8NQMXcEQgjAPoFA5krBTwGUSww/view?usp=sharing' target="_blank">
                    View resume
                  </Button>
                </div> 
              </Grid>
